<html>
<head>
    <title>Boxfuse Sample App: failure!</title>
</head>
<body style="text-align: center">
<h1>Rakesh</h1>
<img src="f">

<h2>You have  your end to end project!</h2>
...
<p>Check out <strong><a href="https://github.com/Rakesh-k-ops/Final_terra">this app</a></strong> from GitHub, modify it, and give it version 2.<br/>You are now ready to fuse and <strong>deploy it with zero downtime</strong> using the commands you already know.</p>
